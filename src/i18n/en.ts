export const en = {
  ...
  'message.basicDone': 'Basic questions done. Want to chat more? (Continue or click "Finish")',
  'message.enoughChat': 'We\'ve chatted quite a bit. Ready to organize into a diary?',
