export const zh = {
  ...
  'message.basicDone': '基础问题问完了，还想继续聊聊吗？（当前 {current}/{total} 轮）',
  'message.enoughChat': '已经聊了 {current} 轮了，要不要整理成日记？',
  'message.lastChance': '已经聊了 {current} 轮。如果还想继续，之后不再询问，你可以自由聊多久都行。确定要结束吗？',
